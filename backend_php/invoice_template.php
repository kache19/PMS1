...
class InvoiceTemplate {
    ...
    private function loadCompanySettings() {
        ...
        $this->companyInfo = [
            'name' => $settings['companyName'] ?? 'MALENYA PHARMACEUTICAL COMPANY',
            'address' => $settings['address'] ?? '123 Pharmacy Street, Dar es Salaam, Tanzania',
            'phone' => $settings['phone'] ?? '+255 700 000 000',
            'email' => $settings['email'] ?? 'info@malenyapharmaceutical.com',
            'website' => $settings['tinNumber'] ?? 'www.malenyapharmaceutical.com', // Using tinNumber as website placeholder
            'tax_id' => $settings['tinNumber'] ?? '123456789',
            'logo_path' => $settings['logo'] ?? '/backend_php/uploads/logos/logo.png',
            'tax_rate' => $settings['taxRate'] ?? '18',
            'payment_terms' => $settings['paymentTerms'] ?? 'Payment is due within 30 days of invoice date. Late payments may incur additional charges.',
            'footer_text' => $settings['footerText'] ?? 'Thank you for your business!'
        ];
    }
    ...
    <div class="invoice-container">
        ...
        <div class="header">
            ...
            <div class="invoice-title">
                <h1>INVOICE</h1>
                <div class="invoice-number">#' . htmlspecialchars($invoice['id']) . '</div>
            </div>
        </div>
